...
//#if defined(__linux)
//#include <sys/time.h>
////typedef gettimeofday  __osip_port_gettimeofday;
//#define gettimeofday __osip_port_gettimeofday
//#endif
...
#define OSIP_INFO4    TRACE_LEVEL7
      TRACE_LEVEL8 = 8,
  #define OSIP_INFO5    TRACE_LEVEL8
    END_TRACE_LEVEL = 9
  } osip_trace_level_t;


  typedef void osip_trace_func_t (char *fi, int li, osip_trace_level_t level, char *chfr, va_list ap);
  typedef void sf_osip_trace_func_t (char *fi, int li, osip_trace_level_t level, char *str);
